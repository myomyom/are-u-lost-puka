# -*- coding: utf-8 -*-
"""are you lost babygirl.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1REAuwzgMyvdr4Fn8LXOWj7JBMEtvfQ2V
"""
...
#Dec 2023
#urlObjets = "https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/objets-trouves-gares/exports/json?lang=fr&refine=date%3A%222023%2F12%22&timezone=Europe%2FBerlin"

uwu = datetime.datetime.now()
year = str(uwu.year)
month = str(uwu.strftime("%m"))
print(uwu.year)
print(uwu.strftime("%m"))
year = str(year)
month = str(month)
...
#   return month
# def changeUrl(y, m):
#   urlObjets = "https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/objets-trouves-gares/exports/json?lang=fr&refine=date%3A%22"+y+"%2F"+m+"%22&timezone=Europe%2FBerlin"
#   return urlObjets
...
def idk(banane):
  ...
  for i, gare in dfObjetsSpecificGare.iterrows():
    if gare['UIC'] == banane:
      #x = pd.DataFrame(str(gare['Objet']) + ': ' + str(gare['Count']))
      x = pd.DataFrame({
        'Objet': gare['Objet'],
        'Count': gare['Count']
      }, index=[0])
...
# def top5(liste):
#   liste = liste.head()
#   return(liste.to_html(classes="table table-striped table-hover table-condensed table-responsive", index=False, max_rows=5, col_space=200))
